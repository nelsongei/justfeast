...
class IntaSendService
{
    ...
    {
        $this->baseUrl        = rtrim(config('intasend.base_url', 'https://sandbox.intasend.com'), '/');
     ...
     * @return array               ['success' => bool, 'invoice_id' => string|null, 'message' => string]
     */
    public function initiateSTKPush(Order $order, string $phone, string $email, string $firstName, string $lastName): array
    {
        ...
        try {
            ...
            $errorMessage = $body['detail'] ?? ($body['message'] ?? 'Failed to initiate STK Push. Please try again.');
    ...
    public static function formatPhone(string $phone): string
    {
        ...
        // If starts with 254 already, keep as-is
        // If starts with something else (e.g. already formatted), trust the input
        return $phone;
    }
}
